                    ...
                    {activeTab === 'finance' && (
                        <motion.div key="finance" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ minHeight: '600px' }}>
                            <div className="card" style={{ marginBottom: '30px' }}>
                                ...
                                {renderTransactions(bookings.filter(b => b.startMs <= Date.now() && b.endMs > Date.now()))}
                            </div>
                            ...
                            <div className="card" style={{ marginBottom: '30px' }}>
                                ...
                                {renderTransactions(bookings.filter(b => b.startMs > Date.now()))}
                            </div>
                            ...
                            <div className="card">
                                ...
                                {renderTransactions(bookings.filter(b => b.endMs <= Date.now()))}
                            </div>
                        </motion.div>
                    )}
                            ...
                            {searchQuery.trim().length > 0 ? (
                                <>
                                    <div className="card" style={{ marginBottom: '30px' }}>
                                        ...
                                        {renderTransactions(bookings.filter(b => b.startMs <= Date.now() && b.endMs > Date.now() && (b.carNumber?.toLowerCase().includes(searchQuery.toLowerCase()) || b.userName?.toLowerCase().includes(searchQuery.toLowerCase()) || b._id?.toLowerCase().includes(searchQuery.toLowerCase()))))}
                                    </div>
                                    ...
                                    <div className="card" style={{ marginBottom: '30px' }}>
                                        ...
                                        {renderTransactions(bookings.filter(b => b.startMs > Date.now() && (b.carNumber?.toLowerCase().includes(searchQuery.toLowerCase()) || b.userName?.toLowerCase().includes(searchQuery.toLowerCase()) || b._id?.toLowerCase().includes(searchQuery.toLowerCase()))))}
                                    </div>
                                    ...
                                    <div className="card">
                                        ...
                                        {renderTransactions(bookings.filter(b => b.endMs <= Date.now() && (b.carNumber?.toLowerCase().includes(searchQuery.toLowerCase()) || b.userName?.toLowerCase().includes(searchQuery.toLowerCase()) || b._id?.toLowerCase().includes(searchQuery.toLowerCase()))))}
                                    </div>
                                </>
                            ) : (
